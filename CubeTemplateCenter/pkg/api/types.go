...
// ArtifactDeleteRequest is the payload sent by CubeMaster to delete an artifact.
type ArtifactDeleteRequest struct {
	ArtifactID string `json:"artifact_id" binding:"required"`
}

// ArtifactDeleteResponse is the response returned after deleting an artifact.
