...
const (
	...
	CubeboxMgr_SnapshotRuntime_FullMethodName           = "/cubelet.services.cubebox.v1.CubeboxMgr/SnapshotRuntime"
...
type CubeboxMgrClient interface {
	...
	// SnapshotRuntime exports VM state and memory from an existing sandbox.
	SnapshotRuntime(ctx context.Context, in *SnapshotRuntimeRequest, opts ...grpc.CallOption) (*SnapshotRuntimeResponse, error)
...
func (c *cubeboxMgrClient) SnapshotRuntime(ctx context.Context, in *SnapshotRuntimeRequest, opts ...grpc.CallOption) (*SnapshotRuntimeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SnapshotRuntimeResponse)
	err := c.cc.Invoke(ctx, CubeboxMgr_SnapshotRuntime_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CubeboxMgrServer interface {
	...
	// SnapshotRuntime exports VM state and memory from an existing sandbox.
	SnapshotRuntime(context.Context, *SnapshotRuntimeRequest) (*SnapshotRuntimeResponse, error)
	// RollbackSandbox restores a running sandbox to a committed snapshot.
...
// UnimplementedCubeboxMgrServer must be embedded to have forward compatible implementations.
...
func (UnimplementedCubeboxMgrServer) AppSnapshot(context.Context, *AppSnapshotRequest) (*AppSnapshotResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AppSnapshot not implemented")
}
func (UnimplementedCubeboxMgrServer) CommitSandbox(context.Context, *CommitSandboxRequest) (*CommitSandboxResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CommitSandbox not implemented")
}
func (UnimplementedCubeboxMgrServer) SnapshotRuntime(context.Context, *SnapshotRuntimeRequest) (*SnapshotRuntimeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SnapshotRuntime not implemented")
}
func (UnimplementedCubeboxMgrServer) RollbackSandbox(context.Context, *RollbackSandboxRequest) (*RollbackSandboxResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RollbackSandbox not implemented")
}
func (UnimplementedCubeboxMgrServer) CleanupTemplate(context.Context, *CleanupTemplateRequest) (*CleanupTemplateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CleanupTemplate not implemented")
}
func (UnimplementedCubeboxMgrServer) ListSandboxSnapshots(context.Context, *ListSandboxSnapshotsRequest) (*ListSandboxSnapshotsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListSandboxSnapshots not implemented")
}
func (UnimplementedCubeboxMgrServer) ListLocalSnapshots(context.Context, *ListLocalSnapshotsRequest) (*ListLocalSnapshotsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListLocalSnapshots not implemented")
}
func (UnimplementedCubeboxMgrServer) GetLocalSnapshot(context.Context, *GetLocalSnapshotRequest) (*GetLocalSnapshotResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetLocalSnapshot not implemented")
}
...
func (UnimplementedCubeboxMgrServer) InspectStorageVolumes(context.Context, *InspectStorageVolumesRequest) (*InspectStorageVolumesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method InspectStorageVolumes not implemented")
}
func (UnimplementedCubeboxMgrServer) CleanupOrphanStorageFiles(context.Context, *CleanupOrphanStorageFilesRequest) (*CleanupOrphanStorageFilesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CleanupOrphanStorageFiles not implemented")
}
...
func _CubeboxMgr_SnapshotRuntime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SnapshotRuntimeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CubeboxMgrServer).SnapshotRuntime(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CubeboxMgr_SnapshotRuntime_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CubeboxMgrServer).SnapshotRuntime(ctx, req.(*SnapshotRuntimeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CubeboxMgr_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SnapshotRuntime",
			Handler:    _CubeboxMgr_SnapshotRuntime_Handler,
		},
		{
