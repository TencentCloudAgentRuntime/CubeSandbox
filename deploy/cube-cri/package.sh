...
files=(bin/cubelet-cri bin/cube-cri-trace-proxy bin/containerd-shim-cube-rs bin/cube-vmm-worker bin/cube-template-builder bin/cube-trace-forwarder assets/kernel assets/agent assets/guest.img)
