...
export TF_VAR_cube_lifecycle_manager_replicas="${TF_VAR_cube_lifecycle_manager_replicas:-${TENCENTCLOUD_CUBE_LIFECYCLE_MANAGER_REPLICAS:-2}}"
...
export TF_VAR_cube_lifecycle_manager_leader_election_enabled="${TF_VAR_cube_lifecycle_manager_leader_election_enabled:-${TENCENTCLOUD_CUBE_LIFECYCLE_MANAGER_LEADER_ELECTION_ENABLED:-true}}"
export TF_VAR_cube_lifecycle_manager_leader_lease_ttl="${TF_VAR_cube_lifecycle_manager_leader_lease_ttl:-${TENCENTCLOUD_CUBE_LIFECYCLE_MANAGER_LEADER_LEASE_TTL:-10s}}"
export TF_VAR_cube_lifecycle_manager_leader_renew_interval="${TF_VAR_cube_lifecycle_manager_leader_renew_interval:-${TENCENTCLOUD_CUBE_LIFECYCLE_MANAGER_LEADER_RENEW_INTERVAL:-3s}}"
export TF_VAR_cube_lifecycle_manager_leader_retry_interval="${TF_VAR_cube_lifecycle_manager_leader_retry_interval:-${TENCENTCLOUD_CUBE_LIFECYCLE_MANAGER_LEADER_RETRY_INTERVAL:-1s}}"
