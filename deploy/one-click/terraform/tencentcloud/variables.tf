...
variable "cubemaster_image" {
  ...
  type        = string
  default     = "cube-sandbox-cn.tencentcloudcr.com/cube-sandbox/cube-master:v0.7.1"
}

variable "cubeapi_image" {
  description = "Full cube-api image override."
  type        = string
  default     = "cube-sandbox-cn.tencentcloudcr.com/cube-sandbox/cube-api:v0.7.1"
}

variable "cubeops_image" {
  description = "Full cube-ops image override."
  type        = string
  default     = "cube-sandbox-cn.tencentcloudcr.com/cube-sandbox/cube-ops:v0.7.1"
}

variable "cubeproxy_image" {
  description = "Full cube-proxy image override."
  type        = string
  default     = "cube-sandbox-cn.tencentcloudcr.com/cube-sandbox/cube-proxy:v0.7.1"
}

variable "webui_image" {
  description = "Full cube-webui image override."
  type        = string
  default     = "cube-sandbox-cn.tencentcloudcr.com/cube-sandbox/cube-webui:v0.7.1"
}

variable "cube_lifecycle_manager_image" {
  description = "Full cube-lifecycle-manager image override."
  type        = string
  default     = "cube-sandbox-cn.tencentcloudcr.com/cube-sandbox/cube-lifecycle-manager:v0.7.1"
}

variable "templatecenter_image" {
  description = "Full cube-templatecenter image override."
  type        = string
  default     = "cube-sandbox-cn.tencentcloudcr.com/cube-sandbox/cube-templatecenter:v0.7.1"
}
